<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Edit.ascx.cs" Inherits="Overworld.Modules.Overworld.Edit" %>
...
<div id="CarouselPane" runat="server" class="carousel slide" containertype="G" containername="Overworld" containersrc="Blank.ascx" />
